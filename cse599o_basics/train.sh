...
# resume_ckpt=../ckpt/10/warmup_500_cosine_4500_lr_1.5e-3_5e-5/ckpt4000.pt
# seed=42
# All lr pairs tried
...
for lr_min_max in $lr_min_maxs; do
    ...
    # LOG_DIR=../logs/10/resume_warmup_${warmup_iters}_cosine_${cosine_iters}_lr_$lr_min_max
    LOG_DIR=../logs/10/warmup_${warmup_iters}_cosine_${cosine_iters}_lr_$lr_min_max
    # CKPT_DIR=../ckpt/10/resume_warmup_${warmup_iters}_cosine_${cosine_iters}_lr_$lr_min_max
